...
const throttledOnDrag = throttle(onDrag,10);
	...
	try {
        ...
        const driverObj = driver({
          ...
          steps: [
            ...
            { element: '#recommentBtn', popover: { title: '推荐', description: '这里将为你推荐你可能"喜欢"的内容"' } },
                    ...
                    <div class="flip-card__inner">
                        <div class="flip-card__front">
                            ...
                            <form class="flip-card__form" @submit="handleLogin">
                                <input v-model="loginForm.username" class="flip-card__input" name="username" placeholder="Username">
                                <input v-model="loginForm.password" class="flip-card__input" name="password" placeholder="password" type="password">
                        ...
                        <div class="flip-card__back">
                            ...
                            <form class="flip-card__form" @submit="handleRegister">
                                <input v-model="registerForm.nickname" class="flip-card__input" placeholder="Name" type="name">
                                <input v-model="registerForm.username" class="flip-card__input" name="username" placeholder="Username">
                                <input v-model="registerForm.password" class="flip-card__input" name="password" placeholder="password" type="password">
